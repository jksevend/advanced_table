...
void main() {
  group('$AdvancedTable - Error tests', () {
    test('$AdvancedTable - Count of definitions does not match count of keys of map entry', () {
      ...
      final List<ColumnDefinition> definitions = [
        ColumnDefinition<String>(valueKey: 'valueOne', title: const Text('Value 1')),
        ColumnDefinition<String>(valueKey: 'valueTwo', title: const Text('Value 2')),
      ...
      // WHEN - THEN
      expect(() => AdvancedTable<TestData>(columnDefinitions: definitions, data: testData),
    ...
    test('$AdvancedTable - Generic type does not have toJson method', () {
      ...
      // WHEN - THEN
      expect(() => AdvancedTable<TestDataNoToJson>(columnDefinitions: definitions, data: testData),
    ...
    testWidgets('$AdvancedTable - Column definition not found', (widgetTester) async {
      ...
      final AdvancedTable table = AdvancedTable(columnDefinitions: definitions, data: testData);
    ...
    testWidgets('$AdvancedTable - Column definition type and value type does not match',
      ...
      final List<ColumnDefinition> definitions = [
        ColumnDefinition<String>(valueKey: 'valueOne', title: const Text('Value 1')),
        ColumnDefinition<int>(valueKey: 'valueTwo', title: const Text('Value 1')),
      ];
    ...
    testWidgets('$AdvancedTable - Column definition type not supported', (widgetTester) async {
      ...
      final List<ColumnDefinition> definitions = [
        ColumnDefinition<String>(valueKey: 'valueOne', title: const Text('Value 1')),
        ColumnDefinition<Map>(valueKey: 'valueTwo', title: const Text('Value 1')),
      ];
  ...
  group('$AdvancedTable - Structural tests', () {
    testWidgets('$AdvancedTable - Basic table structure is created', (widgetTester) async {
      // GIVEN
      final List<ColumnDefinition> definitions = [
        ColumnDefinition<String>(valueKey: 'valueOne', title: const Text('Value 1')),
        ColumnDefinition<String>(valueKey: 'valueTwo', title: const Text('Value 1')),
      ];
      ...
      final int expectedCells = definitions.length * testData.length + definitions.length;
